...
ActiveRecord::Schema.define(version: 20190430200714) do
  ...
  create_table "fga_internship_plugin_checklists", force: :cascade do |t|
    t.string "name"
    t.string "link"
    t.boolean "checked"
    t.datetime "created_at"
    ...
    t.index ["process_id"], name: "index_fga_internship_plugin_checklists_on_process_id"
  end

  create_table "fga_internship_plugin_documents", force: :cascade do |t|
    t.string "name"
    t.string "doc_type"
  ...
  create_table "fga_internship_plugin_task_items", force: :cascade do |t|
    t.text "description"
  ...
  create_table "fga_internship_plugin_task_lists", force: :cascade do |t|
    t.string "name"
    t.string "link"
    t.datetime "created_at"
    t.datetime "updated_at"
