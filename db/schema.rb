...
ActiveRecord::Schema.define(version: 20190516200656) do
  ...
  create_table "custom_forms_plugin_alternatives", force: :cascade do |t|
    ...
    t.integer "position", default: 0
    t.index ["field_id"], name: "index_custom_forms_plugin_alternatives_on_field_id"
  end
  ...
  create_table "custom_forms_plugin_answers", force: :cascade do |t|
    ...
    t.index ["field_id"], name: "index_custom_forms_plugin_answers_on_field_id"
    t.index ["submission_id"], name: "index_custom_forms_plugin_answers_on_submission_id"
  end
  ...
  create_table "custom_forms_plugin_fields", force: :cascade do |t|
    ...
    t.integer "position", default: 0
    t.string "show_as"
    t.index ["form_id"], name: "index_custom_forms_plugin_fields_on_form_id"
  end

  create_table "custom_forms_plugin_form_answers", force: :cascade do |t|
  ...
  create_table "custom_forms_plugin_forms", force: :cascade do |t|
    ...
    t.integer "access", default: 0
    t.index ["article_id"], name: "index_custom_forms_plugin_forms_on_article_id"
    t.index ["profile_id"], name: "index_custom_forms_plugin_forms_on_profile_id"
  end
  ...
  create_table "custom_forms_plugin_submissions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["form_id"], name: "index_custom_forms_plugin_submissions_on_form_id"
    t.index ["profile_id"], name: "index_custom_forms_plugin_submissions_on_profile_id"
  end
  ...
  create_table "fga_internship_plugin_checklists", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "link"
    t.boolean "checked"
    t.datetime "created_at"
    t.integer "document_id"
    t.integer "internship_process_id"
    t.index ["document_id"], name: "index_fga_internship_plugin_checklists_on_document_id", unique: true
    t.index ["internship_process_id"], name: "index_fga_internship_plugin_checklists_on_internship_process_id"
  end

  create_table "fga_internship_plugin_documents", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "doc_type"
    t.string "view_permission", default: [], array: true
    t.string "write_permission", default: [], array: true
    t.string "phase"
    t.datetime "created_at"
  end

  create_table "fga_internship_plugin_processes", force: :cascade do |t|
    t.datetime "created_at"
    t.bigint "community_id"
    t.bigint "supervisor_id"
    t.bigint "student_id"
    t.string "phase", default: "pre-application"
    t.index ["community_id"], name: "index_fga_internship_plugin_processes_on_community_id"
    t.index ["student_id"], name: "index_fga_internship_plugin_processes_on_student_id", unique: true
    t.index ["supervisor_id"], name: "index_fga_internship_plugin_processes_on_supervisor_id"
  end

  create_table "fga_internship_plugin_task_items", id: :serial, force: :cascade do |t|
    t.text "description"
  ...
  create_table "fga_internship_plugin_task_lists", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "link"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "file_internships", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.integer "access", default: 0
    t.string "internship_role", default: "none"
  ...
  add_foreign_key "custom_forms_plugin_forms", "articles"
